...
WebUI.click(findTestObject('Dashboard/Featured products/Add to cart - 25 Virtual Gift Card'))
...
WebUI.click(findTestObject('Dashboard/Detail Product/Tombol Add to wishlist'), FailureHandling.STOP_ON_FAILURE)
