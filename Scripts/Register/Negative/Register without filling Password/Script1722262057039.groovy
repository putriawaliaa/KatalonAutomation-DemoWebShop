...
WebUI.click(findTestObject('Register/Gender Male'))
...
WebUI.verifyElementPresent(findTestObject('Register/Null The password and confirmation password do not match'), 0)
