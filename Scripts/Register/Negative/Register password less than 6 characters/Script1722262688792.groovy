...
WebUI.setText(findTestObject('Register/textbox Password'), 'ibumu')

WebUI.setText(findTestObject('Register/textbox Confirm password'), 'ibumu')

WebUI.click(findTestObject('Register/Tombol Register'))

WebUI.verifyElementPresent(findTestObject('Register/Null The password should have at least 6 characters'), 0)
