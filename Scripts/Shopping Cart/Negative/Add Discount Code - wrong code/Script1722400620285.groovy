...
WebUI.setText(findTestObject('Shopping cart/textbox discountcouponcode'), 'discountday')

WebUI.click(findTestObject('Shopping cart/Tombol Apply Coupon'))

WebUI.verifyElementPresent(findTestObject('Shopping cart/Null The coupon code you entered couldnt be applied to your order'), 
    0)
