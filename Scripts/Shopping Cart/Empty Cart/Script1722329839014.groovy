...
WebUI.click(findTestObject('Shopping cart/Checkbox Remove 1'))

WebUI.click(findTestObject('Shopping cart/Checkbox Remove 2'))

WebUI.click(findTestObject('Shopping cart/Tombol Update Shopping Cart'))

WebUI.verifyElementPresent(findTestObject('Shopping cart/Null Shopping cart'), 0)
