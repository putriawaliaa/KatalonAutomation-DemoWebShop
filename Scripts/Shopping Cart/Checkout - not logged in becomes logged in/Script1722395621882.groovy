...
WebUI.setText(findTestObject('Login/textbox Email'), 'leebada@mailsac.com')

WebUI.setText(findTestObject('Login/textbox Password'), 'ibumuu')

WebUI.click(findTestObject('Login/Tombol Log in'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Shopping cart/Checkbox I agree with the terms of service'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Shopping cart/Tombol Checkout'), FailureHandling.STOP_ON_FAILURE)

'displays the checkout page'
WebUI.verifyElementPresent(findTestObject('Shopping cart/Null Checkout'), 0)
