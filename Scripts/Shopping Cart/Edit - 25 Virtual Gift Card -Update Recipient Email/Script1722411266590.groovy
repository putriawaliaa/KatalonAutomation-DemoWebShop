...
WebUI.setText(findTestObject('Dashboard/Detail Product/textbox recipient email - Virtual Gift Card'), 'nana@mailsac.com')

WebUI.click(findTestObject('Dashboard/Detail Product/Tombol Update'), FailureHandling.STOP_ON_FAILURE)
